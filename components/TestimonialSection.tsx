...
export default function TestimonialSection() {
  return (
    <section className="bg-[#012958] py-12 text-white">
      <motion.div
...
function TestimonialCard({
  ...
  return (
    <div className="bg-white text-[#9CA3AF] rounded-xl p-6 shadow-md flex flex-col justify-between items-center h-full">
      <p className="mb-4">{text}</p>
      <div className="w-full text-left">
        <p className="text-[#FF3366] font-bold">{name}</p>
        <p className="text-[#9CA3AF]">{role}</p>
      </div>
    </div>
  );
}
